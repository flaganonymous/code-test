...
use Session;
use Auth;
use testCRm\CrmLauncher\Models\Contact;
use testCRm\CrmLauncher\Models\CaseOverview;
use testCRm\CrmLauncher\Models\Message;
use testCRm\CrmLauncher\Models\InnerComment;
use testCRm\CrmLauncher\Models\Answer;
use testCRm\CrmLauncher\Models\Log;
use testCRm\CrmLauncher\ApiCalls\FetchTwitterContent;
use testCRm\CrmLauncher\ApiCalls\FetchFacebookContent;
...
class CasesController extends Controller
{
    ...
    /**
     * @var testCRm\CrmLauncher\Models\Innercomment
     */
    protected $innerComment;

    /**
     * @var testCRm\CrmLauncher\Models\Contact
     */
    protected $contact;

    /**
     * @var testCRm\CrmLauncher\Models\Message
     */
    protected $message;

    /**
     * @var testCRm\CrmLauncher\ApiCalls\FetchTwitterContent
     */
    protected $twitterContent;

    /**
     * @var testCRm\CrmLauncher\ApiCalls\FetchFacebookContent
     */
     ...
     * @param testCRm\CrmLauncher\Models\Contact $contact
     * @param testCRm\CrmLauncher\Models\Message $message
     * @param testCRm\CrmLauncher\Models\Innercomment $innerComment
    ...
    private function insertAnswer($type, $request, $case, $message, $reply, $handle)
    {
        ...
        if (is_a($message, "testCRm\CrmLauncher\Models\Answer")) {
