...
class UsersController extends Controller
{
     ...
     * @var testCRm\CrmLauncher\Models\User
     */
    protected $user;

    /**
     * @param testCRm\CrmLauncher\Models\User $user
     */
    ...
    public function postUser(Request $request)
    {
        ...
        return redirect()->action('\testCRm\CrmLauncher\Controllers\UsersController@index');
    }
